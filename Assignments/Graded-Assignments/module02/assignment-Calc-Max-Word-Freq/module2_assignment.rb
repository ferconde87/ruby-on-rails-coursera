...
class LineAnalyzer
  ...
  def calculate_word_frequency
    ...
    @highest_wf_count = word_frequency.values.max if not word_frequency.values.empty?
...
class Solution
  ...
  def print_highest_word_frequency_across_lines
    ...
    self.highest_count_words_across_lines.each do |analyzer|
      puts "#{analyzer.highest_wf_words.strip} (appears in line #{analyzer.line_number})"
    end
  end
end